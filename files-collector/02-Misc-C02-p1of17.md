...
```
cd existing_repo
git remote add origin https://git.soultech.ae/mohamed.osama/trips_frontend.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.soultech.ae/mohamed.osama/trips_frontend/-/settings/integrations)
      ...
      "architect": {
        ...
        "serve": {
          ...
          "configurations": {
            ...
            "development": {
              "buildTarget": "free-version:build:development"
            }
          },
...
## `dashboard_api_specification.md`
